...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover Greece's best small businesses in one place. Browse independent stores, message sellers on WhatsApp, and check out in one cart." },
      { name: "author", content: "Son of Sun Greece" },
      { property: "og:title", content: "Son of Sun Greece" },
      { property: "og:description", content: "A warm marketplace of small Greek makers." },
